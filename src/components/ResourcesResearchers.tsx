        ...
        <div className="bg-gray-50 rounded-xl p-8 border-2 border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Register</h4>
              <p className="text-gray-600">
                Create your researcher profile to access all resources and connect with the network.
              </p>
            </div>
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Explore</h4>
              <p className="text-gray-600">
                Browse our comprehensive library of protocols, tools, and best practices.
              </p>
            </div>
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Collaborate</h4>
              <p className="text-gray-600">
                Connect with other researchers and join collaborative projects.
              </p>
            </div>
          </div>
        </div>
