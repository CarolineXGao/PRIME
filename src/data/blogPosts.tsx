...
export const blogPosts: BlogPost[] = [
  // Research Insights
  {
    ...
    excerpt:
      "Our new commentary calls for urgent action to close the gap between what young people are experiencing and the slow pace of research and policy responses...",
